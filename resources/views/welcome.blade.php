                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="pweb1.html"
                                    class="underline text-gray-900 dark:text-white">Week 1</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="pweb2.html"
                                    class="underline text-gray-900 dark:text-white">Week 2</a></div>
                        </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                CSS
                                <br>
                                <a href="5026221087.html" class="underline text-gray-900 dark:text-white">Tugas
                                    Linktree</a>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="pweb3.html"
                                    class="underline text-gray-900 dark:text-white">Week 3</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Week 4</div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Latihan HTML + bootstrap
                                <br>
                                <a href="progresLatihan1.html" class="underline text-gray-900 dark:text-white">Latihan
                                    1</a>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="pweb5.html"
                                    class="underline text-gray-900 dark:text-white">Week 5</a></div>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="pweb6.html"
                                    class="underline text-gray-900 dark:text-white">Week 6</a></div>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="ETS.html"
                                    class="underline text-gray-900 dark:text-white">Week 7</a></div>
                        </div>
